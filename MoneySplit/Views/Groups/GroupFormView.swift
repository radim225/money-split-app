...
struct GroupFormView: View {
    ...
    var body: some View {
        GroupFormContent(context: modelContext, group: group)
    }
}

private struct GroupFormContent: View {
    @StateObject private var vm: GroupFormViewModel
    @Environment(\.dismiss) private var dismiss

    init(context: ModelContext, group: SplitGroup? = nil) {
        _vm = StateObject(wrappedValue: GroupFormViewModel(context: context, group: group))
    }
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(vm.isEditing ? "Edit Group" : "New Group")
