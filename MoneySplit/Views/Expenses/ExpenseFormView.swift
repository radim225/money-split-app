...
struct ExpenseFormView: View {
    ...
    var body: some View {
        ExpenseFormContent(context: modelContext, group: group, expense: expense)
    }
}
...
private struct ExpenseFormContent: View {
    ...
    init(context: ModelContext, group: SplitGroup, expense: Expense? = nil) {
        self.group = group
        _vm = StateObject(wrappedValue: ExpenseFormViewModel(context: context, group: group, expense: expense))
    }
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(vm.isEditing ? "Edit Expense" : "New Expense")
